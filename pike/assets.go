...
var _Assets336cb40f54e146e1a5477fc39dc37464e5a4f48e = ""
...
var Assets = assets.NewFileSystem(map[string][]string{"/": []string{"templates"}, "/templates": []string{"config.go.tmplt", "compile_proto.sh.tmplt", "storage.go.tmplt", "initial_migration.down.sql.tmplt", "server.go.tmplt", "auth.go.tmplt", "run.go.tmplt", "config.yaml.tmplt", "project_proto.tmplt", "launcher.go.tmplt", "report_error.go.tmplt", "server_entity.go.tmplt", "initial_migration.up.sql.tmplt", "run.sh.tmplt", "storage_entity.go.tmplt"}}, map[string]*assets.File{
	"/templates/server_entity.go.tmplt": &assets.File{
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1591446311, 1591446311708474955),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1591446130, 1591446130425343103),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1591446341, 1591446341802149475),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1590232126, 1590232126862245224),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1590232126, 1590232126863305107),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1591446723, 1591446723022530876),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1591442265, 1591442265013127504),
